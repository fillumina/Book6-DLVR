...
- [5. Introduction to Convolutional Neural Networks (CNNs)](Part II/chapter-5/)
- [6. Modern CNN Architectures](Part II/chapter-6/)
- [7. Introduction to Recurrent Neural Networks (RNNs)](Part II/chapter-7/)
- [8. Modern RNN Architectures](Part II/chapter-8/)
- [9. Self-Attention Mechanisms on CNN and RNN](Part II/chapter-9/)
- [10. Transformer Architectures](Part II/chapter-10/)
- [11. Generative Adversarial Networks (GANs)](Part II/chapter-11/)
- [12. Probabilistic Diffusion Models](Part II/chapter-12/)
- [13. Energy-Based Models (EBMs)](Part II/chapter-13/)
